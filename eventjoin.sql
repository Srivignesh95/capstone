...
INSERT INTO `events` (`id`, `title`, `description`, `event_date`, `event_time`, `hall_id`, `banner_image`, `created_by`, `status`, `rsvp_deadline`, `rsvp_limit`, `created_at`, `is_public`) VALUES
(1, 'Check', 'I love my event', '2025-05-31', '20:00:00', 5, NULL, 2, 'approved', '2025-05-31', 50, '2025-05-08 22:47:28', 0),
(2, 'Testing public event', 'Teging the public event', '2025-05-08', '23:05:00', 5, NULL, 2, 'approved', '2025-05-08', 100, '2025-05-09 01:04:03', 1);
...
(1, 'Srivignesh', 'admin@example.com', '$2a$12$f4EN66j6FHz.j4.ipHVPtOfHZCnVgj258iSoMjF73FS5h9olj6Loa', 'venue_manager'),
(2, 'Srivignesh', 'requestor@example.com', '$2a$12$f4EN66j6FHz.j4.ipHVPtOfHZCnVgj258iSoMjF73FS5h9olj6Loa', 'requestor');

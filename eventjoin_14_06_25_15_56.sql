...
INSERT INTO `events` (`id`, `title`, `description`, `event_date`, `event_time`, `hall_id`, `banner_image`, `created_by`, `status`, `rsvp_deadline`, `rsvp_limit`, `created_at`, `is_public`, `delete_requested`, `rejection_reason`) VALUES
(3, 'Checking event', 'Checking events', '2025-06-30', '15:45:00', 3, 'event_3_1749761171.jpg', 2, 'approved', '2025-06-28', 100, '2025-06-12 16:44:28', 1, 0, NULL),
(4, 'checking RSVP limit', 'Checking the RSVP Limit ', '2025-07-10', '15:37:00', 3, NULL, 2, 'approved', '2025-06-13', 2, '2025-06-12 17:38:20', 0, 1, NULL),
(5, 'Test Admin rejection', 'Check check check=', '2017-09-02', '10:00:00', 4, NULL, 1, 'rejected', '2017-01-02', 500, '2025-06-14 18:03:07', 0, 0, 'Event did not meet the approval criteria.'),
(7, 'fvdfvdfv', 'ergergerger', '2099-07-09', '10:59:00', 2, NULL, 1, 'rejected', '2025-06-20', 99, '2025-06-14 18:15:01', 1, 0, 'Check rejection');
...
(3, 'Srivignesh', 'Kavle', 'Srivignesh Kavle', 'ramnathkavle@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, '$2y$10$JN4RzpUzRVbJm3u7V1Sxjeu0.CLqXOKrPMRRwfDicvRnOxP0MnFh.', 'requestor');
